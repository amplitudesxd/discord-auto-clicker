...
public class Clicker {
    ...
    private static final String TOKEN = JOptionPane.showInputDialog("Please enter your Bot Token");
    private static final String GUILD_ID = JOptionPane.showInputDialog("Please enter your Guild ID");
    private static final String CHANNEL_ID = JOptionPane.showInputDialog("Please enter your Channel ID");
